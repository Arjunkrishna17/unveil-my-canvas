...
const featuredProjects = [
  {
    ...
    description: "Revolutionary low-code platform that reduced app development time by 50%. Features drag-and-drop functionality, AI-supported page creation, and real-time collaboration tools.",
    features: "Creating pages, permissions management, theme customization, drag-and-drop, charts integration, AI page creation",
    tech: ["React", "TypeScript", "Node.js", "Real-time Sync", "AI Integration"],
    link: "https://getzino.com/",
    gradient: "from-cyan-500 via-blue-500 to-purple-500"
  },
  {
    title: "Axon Engineering Metrics",
    description: "Comprehensive analytics dashboard providing engineering leaders with actionable insights. Integrates with GitHub, Bitbucket, Jira, Slack for data-driven decision making.",
    features: "Cycle Time, MTTR, Deployment Frequency, Team Wellbeing, Planning Effectiveness, Multi-platform integrations",
    tech: ["React", "TypeScript", "Tailwind", "Node.js", "MongoDB", "AWS", "Docker"],
    link: "https://www.getaxon.io/",
    gradient: "from-purple-500 via-pink-500 to-orange-500"
  },
  {
    title: "Axon OKR Dashboard",
    description: "Goal-setting framework dashboard with Jira integration for automatic progress tracking. Supports public/private OKRs with role-based permissions.",
    features: "OKR CRUD, Public/Private OKRs, Auto progress tracking, Insights generation, Jira integration",
  ...
  },
  {
    ...
    description: "Individual contribution analytics providing insights into code commits, project involvement, and collaboration patterns.",
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              >
                ...
                <p className="text-xl text-muted-foreground leading-relaxed max-w-xl">
                  I'm <span className="text-foreground font-bold">Krishnadas R</span>, 
                  a Fullstack Software Engineer crafting exceptional web experiences 
                  with cutting-edge technologies, DevOps excellence, and AI integration.
                </p>
                ...
                <div className="grid grid-cols-3 gap-6 pt-8">
                  <div className="space-y-1">
                    <p className="text-4xl font-bold text-gradient-primary">3+</p>
                    <p className="text-sm text-muted-foreground">Years Experience</p>
                  </div>
                  <div className="space-y-1">
                    <p className="text-4xl font-bold text-gradient-secondary">10+</p>
                    <p className="text-sm text-muted-foreground">Projects Built</p>
                  </div>
                  <div className="space-y-1">
                    <p className="text-4xl font-bold text-gradient-accent">50%</p>
              ...
              >
                <div className="relative w-full aspect-square">
                  ...
                  <div className="absolute inset-8 rounded-full border-2 border-secondary/20 animate-ping" style={{ animationDuration: '4s', animationDelay: '1s' }} />
                  <div className="absolute inset-16 rounded-full border-2 border-accent/20 animate-ping" style={{ animationDuration: '5s', animationDelay: '2s' }} />
                  
                  {/* Center Circle */}
                  <div className="absolute inset-20 rounded-full bg-gradient-to-br from-primary/20 via-secondary/20 to-accent/20 backdrop-blur-xl border border-primary/30 flex items-center justify-center shadow-2xl">
                    <motion.div
                      animate={{ rotate: 360 }}
        ...
        <section className="py-32">
          <ScrollReveal>
            <div className="text-center mb-16 space-y-4">
              ...
              <h2 className="text-5xl lg:text-6xl font-bold">
                <span className="text-gradient-accent">Skills</span> & Technologies
              </h2>
            </div>
          </ScrollReveal>
                  ...
                  <div className="space-y-6">
                    <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
                      <div className="space-y-2">
                        ...
                        <p className="text-xl text-gradient-primary font-semibold">{exp.company}</p>
                      </div>
